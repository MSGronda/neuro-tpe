...
from src.graphs import plot_first_layer_lrp, plot_network_graph, heatmap_lrp
from src.lrp import lrp, get_X_of_class_y, X_POS, normalize_r, normalized_matrix
...
if __name__ == '__main__':
    ...
    # Aplicamos el LRP
    test_subset = get_X_of_class_y(X_test, y_test, 2)   # Elegimos datos de prueba de UNA clase
    ...
    for i in range(0, 4):
        ...
        plot_network_graph(lrp_results[i], model)
